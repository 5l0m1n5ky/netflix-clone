...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Movie::create([
            'title' => 'Co na ruszcie?',
            'cover' => 'media/burger-4145977_1280.jpg',
            ...
            'production' => 'USA',
            'media_path' => 'media/burger_-_124823 (720p).mp4'
        ],);
        Movie::create([
            'title' => 'LAS',
            'cover' => 'media/california-4053982_1280.jpg',
            ...
            'production' => 'UK',
            'media_path' => 'media/pexels-cottonbro-5427575 (360p).mp4',
        ],);
        Movie::create([
            'title' => 'Just Podcast',
            'cover' => 'media/audio-1844798_1280.jpg',
            ...
            'production' => 'Japonia',
            'media_path' => 'media/pexels-tea-oebel-6892734 (360p).mp4',
        ],);
        Movie::create([
            'title' => 'Almost Fight Club',
            'cover' => 'media/boxing-62867_1280.jpg',
            ...
            'production' => 'USA',
            'media_path' => 'media/production_id_4761713 (360p).mp4',
        ]);
        Genre::create([
